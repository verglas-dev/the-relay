...
export type ThemeFont = "sans" | "display" | "mono" | "comic" | "impact" | "courier" | "georgia" | "verdana" | "trebuchet" | "papyrus";
...
export type RelayMessage = ["EVENT", string, RelayEvent] | ["OK", string, boolean, string] | ["EOSE", string] | ["NOTICE", string];
export type ClientMessage = ["EVENT", RelayEvent] | ["REQ", string, ...Filter[]] | ["CLOSE", string];
